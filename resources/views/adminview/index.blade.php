<!DOCTYPE html><html lang="en"><head>
     ...
     <!-- App favicon -->
     <link rel="shortcut icon" href="admincss/images/favicon.ico">

     <!-- Vendor css (Require in all Page) -->
     <link href="admincss/css/vendor.min.css" rel="stylesheet" type="text/css">

     <!-- Icons css (Require in all Page) -->
     <link href="admincss/css/icons.min.css" rel="stylesheet" type="text/css">

     <!-- App css (Require in all Page) -->
     <link href="admincss/css/app.min.css" rel="stylesheet" type="text/css">

     <!-- Theme Config js (Require in all Page) -->
     <script src="admincss/js/config.js"></script>
</head>
                                   ...
                                   <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end" aria-labelledby="page-header-notifications-dropdown">
                                        ...
                                        <div data-simplebar="" style="max-height: 280px;">
                                             ...
                                             <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                                  <div class="d-flex">
                                                       <div class="flex-shrink-0">
                                                            <img src="admincss/images/avatar-1.jpg" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-1">
                                                       </div>
                                             ...
                                             <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                                  <div class="d-flex">
                                                       <div class="flex-shrink-0">
                                                            <img src="admincss/images/avatar-3.jpg" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-3">
                                                       </div>
                                                       <div class="flex-grow-1">
                                             ...
                                             <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                                  <div class="d-flex">
                                                       <div class="flex-shrink-0">
                                                            <img src="admincss/images/avatar-5.jpg" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-5">
                                                       </div>
                                                       <div class="flex-grow-1">
                    ...
                    <div class="offcanvas-body p-0">
                         <div data-simplebar="" class="h-100 p-4">
                              <div class="position-relative ms-2">
                                   ...
                                   <div class="position-relative ps-4">
                                        <div class="mb-4">
                                             <span class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img src="images/avatar-7.jpg" alt="avatar-5" class="avatar-sm rounded-circle"></span>
                                             <div class="ms-2">
                                                  ...
                                                  <div class="row g-2 mt-2">
                                                       <div class="col-lg-4">
                                                            <a href="#!">
                                                                 <img src="images/img-6.jpg" alt="" class="img-fluid rounded">
                                                            </a>
                                                       </div>
                                                       <div class="col-lg-4">
                                                            <a href="#!">
                                                                 <img src="images/img-3.jpg" alt="" class="img-fluid rounded">
                                                            </a>
                                                       </div>
                                                       <div class="col-lg-4">
                                                            <a href="#!">
                                                                 <img src="images/img-4.jpg" alt="" class="img-fluid rounded">
                                                            </a>
                                                       </div>
                                                  </div>
                                   ...
                                   <div class="position-relative ps-4">
                                        <div class="mb-4">
                                             <span class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img src="images/avatar-6.jpg" alt="avatar-5" class="avatar-sm rounded-circle"></span>
                                             <div class="ms-2">
          ...
          <div class="main-nav">
               ...
               <div class="logo-box">
                    <a href="index.html" class="logo-dark">
                         <img src="admincss/images/logo-sm.png" class="logo-sm" alt="logo sm">
                         <img src="admincss/images/logo-dark.png" class="logo-lg" alt="logo dark">
                    </a>

                    <a href="index.html" class="logo-light">
                         <img src="admincss/images/logo-sm.png" class="logo-sm" alt="logo sm">
                         <img src="admincss/images/logo-light.png" class="logo-lg" alt="logo light">
                    </a>
               </div>
                                        ...
                                        <table class="table mb-0">
                                             ...
                                             <tbody>
                                                  <tr>
                                                       ...
                                                       <td>29 April 2024</td>
                                                       <td>
                                                            <img src="admincss/images/product-1%281%29.png" alt="product-1(1)" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>25 April 2024</td>
                                                       <td>
                                                            <img src="admincss/images/product-4.png" alt="product-4" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>25 April 2024</td>
                                                       <td>
                                                            <img src="admincss/images/product-5.png" alt="product-5" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>21 April 2024</td>
                                                       <td>
                                                            <img src="admincss/images/product-6.png" alt="product-6" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>18 April 2024</td>
                                                       <td>
                                                            <img src="admincss/images/product-1%282%29.png" alt="product-1(2)" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                   ...
                   <div class="container-fluid">
                       <div class="row">
                           <div class="col-12 text-center">
                               <script>document.write(new Date().getFullYear())</script>2025 © Larkon. Crafted by <iconify-icon icon="iconamoon:heart-duotone" class="fs-18 align-middle text-danger"></iconify-icon> <a href="https://1.envato.market/techzaa" class="fw-bold footer-text" target="_blank">Techzaa</a>
                           </div>
                       </div>
                   </div>
               </footer>
